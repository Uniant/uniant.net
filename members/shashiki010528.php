...
<html lang="ja">
    <head>
        ...
        <title>射敷文 - Uniant</title>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@UniantJapan">
        <meta property="og:url" content="https://uniant.net/members/shashiki010528">
        <meta property="og:title" content="射敷文 - Uniant">
    ...
    <body>
        ...
        <div class="membersname">
            <div class="membersnametext">
                <span class="name">射敷 文</span><br>
                <span class="nameeng">Shashiki Aya</span><br><br>
                <span class="mail">shashiki010528@uniant.net</span>
            </div>
        </div>
        <div class="content">
            <div class="about">
