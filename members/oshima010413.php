...
<html lang="ja">
    <head>
        ...
        <title>大島あおい - Uniant</title>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@UniantJapan">
        <meta property="og:url" content="https://uniant.net/members/oshima010413">
        <meta property="og:title" content="大島あおい - Uniant">
    ...
    <body>
        ...
        <div class="membersname">
            <div class="membersnametext">
                <span class="name">大島 あおい</span><br>
                <span class="nameeng">Oshima Aoi</span><br><br>
                <span class="mail">oshima010413@uniant.net</span>
            </div>
        </div>
        <div class="content">
            <div class="about">
                ...
                <div class="sns">
                    ...
                    <span class="twitter"><a href="https://twitter.com/sharp_NEKO" target="_blank" rel="noopener noreferrer"><img src="twitter.png" alt="Twitter:" class="socialicon">@sharp_NEKO</a></span>
                    <span class="github"><a href="https://github.com/sharp-NEKO" target="_blank" rel="noopener noreferrer"><img src="github.png" alt="GitHub:" class="socialicon">@sharp-NEKO</a></span>
                    </div>
                </div>
            </div>
        </div>
