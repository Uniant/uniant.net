...
<html lang="ja">
    ...
    <body>
        ...
        <div class="content">
            <span class="titlesearchresult" id="titleresult">検索結果</span>
            <ul id="ul"></ul>
        </div>
        <div class="footer">
        ...
        <script>
            ...
            document.getElementById('titleresult').innerText = value + " の検索結果";
            document.title = value + " の検索結果 - Uniant";
