...
<html lang="ja">
    <head>
        ...
        <title>鈴木崇央 - Uniant</title>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@UniantJapan">
        <meta property="og:url" content="https://uniant.net/members/suzuki010914">
        <meta property="og:title" content="鈴木崇央 - Uniant">
    ...
    <body>
        ...
        <div class="membersname">
            <div class="membersnametext">
                <span class="name">鈴木 崇央</span><br>
                <span class="nameeng">Suzuki Takahiro</span><br><br>
                <span class="mail">suzuki010914@uniant.net</span>
            </div>
        </div>
        <div class="content">
            <div class="about">
                ...
                <div class="sns">
                    ...
                    <span class="twitter"><a href="https://twitter.com/clown_kuraun" target="_blank" rel="noopener noreferrer"><img src="twitter.png" alt="Twitter:" class="socialicon">@clown_kuraun</a></span>
                    </div>
                </div>
            </div>
        </div>
