...
<html lang="ja">
    <head>
        ...
        <title>伊豆島武史 - Uniant</title>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@UniantJapan">
        <meta property="og:url" content="https://uniant.net/members/izushima011103">
        <meta property="og:title" content="伊豆島武史 - Uniant">
    ...
    <body>
        ...
        <div class="membersname">
            <div class="membersnametext">
                <span class="name">伊豆島 武史</span><br>
                <span class="nameeng">Izushima Takeshi</span><br><br>
                <span class="mail">izushima011103@uniant.net</span>
            </div>
        </div>
        <div class="content">
            <div class="about">
                ...
                <div class="sns">
                    ...
                    <span class="twitter"><a href="https://twitter.com/Okaze1103" target="_blank" rel="noopener noreferrer"><img src="twitter.png" alt="Twitter:" class="socialicon">@Okaze1103</a></span>
                    </div>
                </div>
            </div>
        </div>
