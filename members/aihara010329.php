...
<html lang="ja">
    <head>
        ...
        <title>相原健二 - Uniant</title>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@UniantJapan">
        <meta property="og:url" content="https://uniant.net/members/aihara010329">
        <meta property="og:title" content="相原健二 - Uniant">
    ...
    <body>
        ...
        <div class="membersname">
            <div class="membersnametext">
                <span class="name">相原 健二</span><br>
                <span class="nameeng">Aihara Kenji</span><br><br>
                <span class="mail">aihara010329@uniant.net</span>
            </div>
        </div>
        <div class="content">
            <div class="about">
                ...
                <div class="sns">
                    ...
                    <span class="twitter"><a href="https://twitter.com/Harumaki4185" target="_blank" rel="noopener noreferrer"><img src="twitter.png" alt="Twitter:" class="socialicon">@Harumaki4185</a></span>
                    </div>
                </div>
            </div>
        </div>
