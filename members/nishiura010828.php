...
<html lang="ja">
    <head>
        ...
        <title>西浦恭太 - Uniant</title>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@UniantJapan">
        <meta property="og:url" content="https://uniant.net/members/nishiura010828">
        <meta property="og:title" content="西浦恭太 - Uniant">
    ...
    <body>
        ...
        <div class="membersname">
            <div class="membersnametext">
                <span class="name">西浦 恭太</span><br>
                <span class="nameeng">Nishiura Kyota</span><br><br>
                <span class="mail">nishiura010828@uniant.net</span>
            </div>
        </div>
        <div class="content">
            <div class="about">
                ...
                <div class="sns">
                    ...
                    <span class="twitter"><a href="https://twitter.com/Im_Sleepy_laugh" target="_blank" rel="noopener noreferrer"><img src="twitter.png" alt="Twitter:" class="socialicon">@Im_Sleepy_laugh</a></span>
                    </div>
                </div>
            </div>
        </div>
